...
- Même UUID/corps/auteur : réponse idempotente avec vue **actuelle**. Autre corps/action/auteur : conflit. L'empreinte du corps est un HMAC, pas un hash permettant de tester hors ligne les PIN possibles.
