...
**Point de reprise actuel :** branche `codex/pickup-payment-recovery` ; bascule jusqu'à `8dd81c2`, backend encaissement `364b16e`, POS `2bc33b1`, recettes navigateur durables `54a4e4c`. Prochaine porte : synchronisation avec `origin/develop` (`fa0454d`, #119), CI globale puis PR/recette staging. Dernier staging vérifié : [33995789151](https://github.com/GLWebDevAgency/snack-manager/actions/runs/33995789151), réussi sur ce SHA. La production n'a pas été modifiée par ces lots.
