...
**Point de reprise actuel :** [PR #120](https://github.com/GLWebDevAgency/snack-manager/pull/120) ouverte vers `develop`, branche `codex/pickup-payment-recovery` poussée ; bascule jusqu'à `8dd81c2`, backend encaissement `364b16e`, POS `2bc33b1`, recettes navigateur durables `54a4e4c`. `origin/develop` (`fa0454d`, #119) intégré par `570189a` ; CI [33998511355](https://github.com/GLWebDevAgency/snack-manager/actions/runs/33998511355) et secrets verts, dont **121/121 tests Mongo exécutés**. Toute modification ultérieure exige une nouvelle CI verte. Prochaines portes : dernière recette navigateur, fenêtre de bascule sans ancien writer, fusion par PR puis recette staging. Dernier staging vérifié : [33995789151](https://github.com/GLWebDevAgency/snack-manager/actions/runs/33995789151), réussi sur `fa0454d`. La production n'a pas été modifiée par ces lots.
...
L'ancien POS déployé ne propose pas ce parcours. **L0 l'implémente sur la branche de travail, sans attester encore un déploiement** : modale dédiée à la commande existante, panier courant préservé, espèces/TPE externe/titre-restaurant, montant et rendu validés par le serveur. L'écran de nouvelle vente n'est pas réutilisé.
