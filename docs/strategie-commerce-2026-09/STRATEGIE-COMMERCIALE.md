...
|---|---:|---|
| Fidélité seule | 39 € | Carte publique, programme points/tampons, récompenses et administration ; aucune caisse requise |
| Click & collect | 79 € | Commande et paiement en ligne, retrait, back-office de traitement, fidélité incluse |
...
| Boost | 199 € | Complet + collect/fidélité et support prioritaire ; livraison non incluse |
...
`Vitrine sur mesure → lien du restaurant → commande personnalisée → paiement → réception back-office → préparation → retrait ou livraison restaurant → fidélité`
...
3. Devis modulaire : abonnement, mise en service, vitrine, matériels, paiement, limites, conditions de support, étapes de réception. Livraison en pilote explicitement séparé.
...
2. Recette autonome collect/fidélité et opérations paiement ; fonctions souscrites réellement utilisables sans POS.
