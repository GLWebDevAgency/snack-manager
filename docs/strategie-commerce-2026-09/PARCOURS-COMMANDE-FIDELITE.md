...
Les réponses de connexion tolèrent jusqu’à 30 secondes de décalage entre horloges pour leur seule borne future de plausibilité. Sans cette marge, une intention créée pour dix minutes peut être refusée par le relais web dès que son horloge retarde de quelques millisecondes, avant l’émission de sa preuve privée. Cette tolérance ne modifie aucune échéance serveur : expiration, durée minimale avant publication du cookie, correspondance des identités et plafonds des reçus restent stricts. Une réponse perdue ne permet toujours pas de réémettre sa preuve à usage unique ; sa fermeture explicite précède toute nouvelle tentative.
