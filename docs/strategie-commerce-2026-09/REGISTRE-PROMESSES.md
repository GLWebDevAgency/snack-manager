...
| Fidélité autonome | Carte, programme points/tampons, récompenses et administration présents ; application autonome proposée. | Module `loyalty`. Tester QR réel, identité, reconnexion, rôles, expiration et récompense. Attribution automatique liée aux commandes à vérifier séparément, pas promise universellement. |
