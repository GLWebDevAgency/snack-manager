...
L'[ADR 0005](../adr/0005-facturation-stripe-billing-ou-maison.md) prévoit une bascule vers Stripe Billing ; l'[ADR 0006](../adr/0006-migration-billing-pilotee-par-crm.md) ajoute désormais sa préparation au chantier en cours, par lots CRM/Billing/Invoicing dédiés. Les abonnements, prélèvements récurrents, prorations, Customer Portal et relances automatiques ne sont **pas** activés par le pont Checkout actuel : il faut d'abord décider de la coupure de numérotation, migration des contrats/remises, source d'échéance et traitement des anciennes pièces. Aucun renouvellement manuel par PaymentIntent n'est ajouté.
