...
Le fondateur confirme ne pas avoir de prestataire SMS. **Prestataire et plafond non choisis, aucune dépense autorisée ni intégration activée.** Proposition : service OTP géré avec budget pilote explicite et protection contre les envois abusifs ; alternative email vérifié si le produit accepte que cela ne vérifie pas le téléphone. Les offres gratuites/essais sont une aide au pilote, pas une promesse d'envois SMS gratuits illimités.
