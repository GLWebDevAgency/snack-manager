...
/** Bloque tout DDL fidélité avant la première requête non chiffrée. */
export async function assertLoyaltyMigrationConnectionEncrypted(
  ...
  if (
    ...
    throw new Error('La connexion DDL fidélité doit utiliser TLS 1.2 ou supérieur');
  }
}
