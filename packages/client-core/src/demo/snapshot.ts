...
export interface SnapshotProduct {
  ...
  outOfStock?: boolean;
  /**
   * Photo du PAQUET WEB (`/photos/…`), jamais un média.
   *
   * La démonstration n'a pas de médiathèque et n'en simule pas une : elle sert
   * exactement le repli hérité que `photoUrlDe` rend quand un produit n'a
   * aucune référence — la même chose, aux mêmes adresses, que la démonstration
   * de la vitrine (`apps/web/.../demo/carte.ts`). Le chemin est racine-relatif :
   * il désigne le paquet web, qui n'est PAS l'origine des surfaces terrain.
   * C'est à elles de le résoudre (`apps/pos/src/photo.ts`).
   */
  photo?: string;
}
...
export const SNAPSHOT_PRODUCTS: SnapshotProduct[] = [
  ...
  {"id":"p2","name":"Kebab","price":750,"groups":["g1","g2"],"supplements":"s2","removables":"r2","photo":"/photos/doner-kebab.webp"},
  ...
  {"id":"p7","name":"Kebab Fromage","description":"Kebab, fromage au choix","price":850,"groups":["g3","g4"],"supplements":"s5","removables":"r3","photo":"/photos/doner-kebab.webp"},
  ...
  {"id":"p22","name":"Maxi Kebab","description":"Double viande kebab","price":990,"groups":["g3","g4"],"supplements":"s2","removables":"r2","photo":"/photos/doner-kebab.webp"},
  {"id":"p23","name":"Galette 4 Fromages","description":"Kebab, 4 fromages","price":990,"groups":["g3","g4"],"supplements":"s20","removables":"r10","isNew":true,"photo":"/photos/wrap-tenders.webp"},
  {"id":"p24","name":"Galette Burrata","description":"Kebab ou tenders, burrata, tomate grillée, crème balsamique","price":1100,"groups":["g3","g4"],"supplements":"s2","removables":"r11","isNew":true,"photo":"/photos/wrap-tenders.webp"},
  {"id":"p25","name":"Le Classic","price":950,"groups":["g2"],"supplements":"s4","removables":"r12","photo":"/photos/black-burger.webp"},
  {"id":"p26","name":"Le Crousty","description":"Steak 130 g, poulet crousty, cheddar","price":1250,"groups":["g4"],"supplements":"s21","removables":"r12","photo":"/photos/black-burger.webp"},
  {"id":"p27","name":"Le Chèvre Miel","description":"Steak 130 g, chèvre, miel","price":1250,"groups":["g4"],"supplements":"s22","removables":"r13","photo":"/photos/black-burger.webp"},
  {"id":"p28","name":"Le Gourmet","description":"Steak 130 g, œuf, bacon, cheddar","price":1250,"groups":["g4"],"supplements":"s17","removables":"r14","photo":"/photos/black-burger.webp"},
  {"id":"p29","name":"Le Montagnard","description":"Steak 130 g, œuf, raclette fondante","price":1250,"groups":["g4"],"supplements":"s23","removables":"r15","photo":"/photos/black-burger.webp"},
  {"id":"p30","name":"Le Red","description":"Steak 130 g, camembert, lardons grillés","price":1250,"groups":["g4"],"supplements":"s24","removables":"r16","isNew":true,"photo":"/photos/black-burger.webp"},
  {"id":"p31","name":"Le Black","description":"Steak 130 g, bleu, bacon","price":1250,"groups":["g4"],"supplements":"s25","removables":"r17","isNew":true,"photo":"/photos/black-burger.webp"},
  {"id":"p32","name":"Le King","description":"Double steak 130 g, œuf, cheddar","price":1490,"groups":["g4"],"supplements":"s19","removables":"r14","photo":"/photos/black-burger.webp"},
  ...
  {"id":"p37","name":"Fish","description":"Poisson pané, cheddar","price":750,"groups":["g4"],"supplements":"s27","removables":"r18","photo":"/photos/fish-burger.webp"},
  ...
  {"id":"p42","name":"Le 180","description":"Steak 180 g, cheddar","price":950,"groups":["g4"],"supplements":"s4","removables":"r18","tags":["Mega Burger"],"photo":"/photos/mega-burger-long.webp"},
  {"id":"p43","name":"Le 360","description":"Deux steaks 180 g, cheddar","price":1300,"groups":["g4"],"supplements":"s4","removables":"r18","tags":["Mega Burger"],"photo":"/photos/mega-burger-long.webp"},
  {"id":"p44","name":"Le 540","description":"Trois steaks 180 g, cheddar","price":1600,"groups":["g4"],"supplements":"s4","removables":"r18","tags":["Mega Burger"],"photo":"/photos/mega-burger-long.webp"},
  ...
  {"id":"p46","name":"Compose ton Tacos","description":"Taille, viandes, suppléments, sauces — servi avec frites","price":0,"variants":[{"key":"M","name":"M — 1 viande","price":890},{"key":"L","name":"L — 2 viandes","price":990},{"key":"XL","name":"XL — 3 viandes","price":1250},{"key":"XXL","name":"XXL — 4 viandes","price":1450}],"groups":["g6","g7","g8","g9","g10","g4"],"supplements":"s31","removables":"r22","photo":"/photos/tacos-hero.webp"},
  ...
  {"id":"p49","name":"Bun's","description":"Pain bun toasté, viandes au choix","price":0,"variants":[{"key":"M","name":"M — 1 viande","price":890},{"key":"L","name":"L — 2 viandes","price":990}],"groups":["g13","g4"],"supplements":"s32","removables":"r24","photo":"/photos/mega-burger-long.webp"},
  {"id":"p50","name":"Panini au choix","description":"Merguez · Thon · Kebab · Steak · Poulet · Merguez ou poulet chorizo · Steak chèvre · Steak chèvre miel · Jambon de dinde","price":700,"groups":["g14","g15"],"supplements":"s33","removables":"r25","photo":"/photos/panini-menu.webp"},
  ...
  {"id":"p53","name":"H1 — 2 steaks","description":"Cheddar, crudités & frites","price":790,"groups":["g4"],"supplements":"s4","removables":"r18","photo":"/photos/hummers-stack.webp"},
  {"id":"p54","name":"H2 — 4 steaks","description":"Cheddar, crudités & frites","price":990,"groups":["g4"],"supplements":"s4","removables":"r18","photo":"/photos/hummers-stack.webp"},
  {"id":"p55","name":"H3 — 6 steaks","description":"Cheddar, crudités & frites","price":1200,"groups":["g4"],"supplements":"s4","removables":"r18","photo":"/photos/hummers-stack.webp"},
  {"id":"p56","name":"H4 — 8 steaks","description":"Cheddar, crudités & frites","price":1490,"groups":["g4"],"supplements":"s4","removables":"r18","isNew":true,"photo":"/photos/hummers-stack.webp"},
  {"id":"p57","name":"Salade César","description":"Salade, tomates, poulet pané","price":750,"supplements":"s36","removables":"r24","photo":"/photos/salade-cesar.webp"},
  ...
  {"id":"p71","name":"Le Boss","description":"Pur bœuf, cheddar, onion rings, cornichons — le patron","price":1350,"supplements":"s4","removables":"r36","tags":["Burger"],"photo":"/photos/smash-burger.webp"},
  {"id":"p72","name":"Le Bo Goss","description":"Escalope de poulet, jambon, œuf, tomate grillée, oignons frits","price":1250,"supplements":"s43","removables":"r37","tags":["Burger"],"photo":"/photos/smash-burger.webp"},
  {"id":"p73","name":"Bling Bling","description":"Pur bœuf, escalope de poulet, crème balsamique, sauce maison, oignons frie","price":1250,"supplements":"s44","removables":"r38","tags":["Burger"],"photo":"/photos/smash-burger.webp"},
  {"id":"p74","name":"Egg 180","description":"Steaks 180g, œuf, sauce cheddar, oignons grillés","price":1190,"supplements":"s45","removables":"r39","tags":["Mega Burger"],"photo":"/photos/smash-burger.webp"},
  {"id":"p75","name":"Le Smash","description":"Smash burgers trempés dans une sauce cream cheese fondante","price":0,"variants":[{"key":"simple","name":"Simple","price":950},{"key":"double","name":"Double","price":1250},{"key":"triple","name":"Triple","price":1490}],"supplements":"s4","removables":"r40","photo":"/photos/smash-burger.webp"},
  {"id":"p76","name":"Le Smash Chicken","description":"La version poulet croustillant","price":950,"supplements":"s26","removables":"r40","photo":"/photos/smash-burger.webp"},
  {"id":"p77","name":"Le Double Kif","description":"Double smash, double plaisir","price":1690,"supplements":"s4","removables":"r40","tags":["1+1"],"photo":"/photos/smash-burger.webp"},
  ...
  {"id":"p79","name":"Nuggets","price":0,"variants":[{"key":"5","name":"5 pcs","price":600},{"key":"10","name":"10 pcs","price":1100}],"supplements":"s46","photo":"/photos/nuggets.avif"},
  {"id":"p80","name":"Wings","price":0,"variants":[{"key":"5","name":"5 pcs","price":600},{"key":"10","name":"10 pcs","price":1100}],"supplements":"s35"},
  {"id":"p81","name":"Mozza sticks","price":0,"variants":[{"key":"5","name":"5 pcs","price":600},{"key":"10","name":"10 pcs","price":1100}],"supplements":"s35","photo":"/photos/mozza-stick.webp"},
  ...
  {"id":"p100","name":"Milkshake Nature, vanille, fraise","description":"Coulis : fraise, caramel ou chocolat","price":0,"variants":[{"key":"classique","name":"Classique","price":350},{"key":"xl","name":"XL","price":590}],"photo":"/photos/milkshake-oreo.webp"},
  {"id":"p101","name":"Milkshake Oréo ou Bueno","description":"Coulis : fraise, caramel ou chocolat","price":0,"variants":[{"key":"classique","name":"Classique","price":400},{"key":"xl","name":"XL","price":690}],"photo":"/photos/milkshake-oreo.webp"},
