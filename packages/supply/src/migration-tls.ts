...
/** Bloque tout DDL déployé avant la première requête non chiffrée. */
export async function assertSupplyMigrationConnectionEncrypted(
  ...
  if (
    ...
    throw new Error('La connexion DDL supply doit utiliser TLS 1.2 ou supérieur');
  }
}
