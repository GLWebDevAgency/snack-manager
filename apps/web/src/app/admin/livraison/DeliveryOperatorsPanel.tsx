...
export function DeliveryOperatorsPanel() {
  ...
  return <>
    <Panel title="Vos livreurs" sub="Un accès dédié à la livraison, sans abonnement RH ni accès à la caisse.">
      ...
      <p className="mt-4 border-t border-line pt-4 text-xs leading-relaxed text-mut">« Téléphone associé » ne signifie pas que le livreur est en ligne ou géolocalisé. Le départ et la remise restent gérés depuis Commandes. Les missions sur téléphone seront proposées dans une prochaine étape.</p>
    </Panel>
