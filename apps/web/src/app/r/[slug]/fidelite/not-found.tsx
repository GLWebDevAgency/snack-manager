...
export default function LoyaltyNotFound() {
  return (
    <main className="grid min-h-dvh place-items-center bg-bg px-5 py-12 text-ink">
      <section className="w-full max-w-md rounded-wide border border-white/10 bg-surface p-6 text-center shadow-deep sm:p-8">
        <span className="mx-auto grid size-14 place-items-center rounded-card bg-white/6 text-mut">
