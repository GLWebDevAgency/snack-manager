import { COMMERCE_LABELS, COMMERCE_PRICES, NEW_QUOTE_NOTE } from "./commercial-catalog";
...
export const COMMERCE_OFFERS = [
  ...
  },
  {
    ...
    status: "Sur devis, après validation de la configuration",
    pilot: false,
    note: LOYALTY_PILOT_NOTE,
...
export const COMMERCE_TERMS = {
  ...
  boost: "Dans les nouveaux devis, Boost comprend le click & collect, la livraison par votre restaurant et le pilote fidélité accompagné, sans supplément. L’ouverture de la livraison nécessite la configuration des zones, tarifs et créneaux et la validation du parcours pilote. Les frais de paiement et les coûts de vos livreurs restent distincts.",
  note: `Prix HT par mois et par établissement. Une fonction déjà incluse n'est pas facturée deux fois. ${NEW_QUOTE_NOTE}`,
};
