...
export function CustomerMemoryControls({ details }: { details: ReturnType<typeof useCustomerDetails> }) {
  ...
  const action = "min-h-11 rounded-ctrl px-3 py-2 text-[13px] font-semibold transition-colors duration-fast ease-sm focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-focus disabled:opacity-50 motion-reduce:transition-none";
