 ...
 */
const CONTROL =
  "rounded-ctrl border border-ink/8 bg-ink/5 px-3.5 py-3 text-sm font-medium text-ink outline-none transition-colors duration-fast ease-sm placeholder:text-mut hover:border-ink/16 focus:border-focus focus:bg-ink/8 disabled:cursor-not-allowed disabled:opacity-40 disabled:hover:border-ink/8";
