/** Tracés du kit Caisse v2, partagés entre react-native-web et le futur client natif. */
...
export function Icon({ name, size = 18, color, strokeWidth = 1.9, style }: {
  ...
  return <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color ?? palette.text}
